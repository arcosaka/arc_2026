...
bool espnow_getrx(u1* pu1_rxdata) {
    bool bi_ret = false;
#ifdef USE_ESPNOW
    ESPNOW_UPDATE_S();
    if(NowSerial.read(pu1_rxdata, ESPNOW_BUFFSIZE) == ESPNOW_BUFFSIZE){
        bi_ret = true;
    }
    ESPNOW_UPDATE_E();
#endif /* USE_ESPNOW */
...
bool espnow_settx(u1* pu1_txdata) {
    bool bi_ret = false;
#ifdef USE_ESPNOW
    ESPNOW_UPDATE_S();
    if(NowSerial.write(pu1_txdata, ESPNOW_BUFFSIZE) == ESPNOW_BUFFSIZE){
        bi_ret = true;
    }
    ESPNOW_UPDATE_E();
#endif /* USE_ESPNOW */
